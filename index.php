            ...
            <div class="span6">
                <div class="pull-right">
                    ...
                    <form id="login_form1" class="form-signin" method="post" action="login.php">
                        ...
                        <button data-placement="right" title="Click Here to Sign In" id="signin" name="login"
                            class="btn btn-info" type="submit"><i class="icon-signin icon-large"></i> Sign in</button>
        ...
        return false;
                    ...
                    <div id="button_form" class="form-signin">
                        ...
                        <button data-placement="top" title="Sign In as Student" id="signin_student"
                            onclick="window.location='signup_student.php'" id="btn_student" name="login"
                            class="btn btn-info" type="submit">I`m a Student</button>
                        <div class="pull-right">
